...
namespace snake
{
    ...
    {   //будем хранить переданное направление для перемещения
        ...
        //проверяем не встретилась ли головная точка змейки с другой точкой змейки
        internal bool IsHitTail()
        {
            //получаем головную точку
            Point head = pLine.Last();
            //проверяем по точечно не пересеклась ли головная точка с любой другой точкой змеи
